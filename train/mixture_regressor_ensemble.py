...
def train_model(training_data_df, df_percept, mixture_definitions_df, all_cids, X_t, y_t, data_percept, percept_ids):
    ...
    out_file = DIR_OUTPUT / f"D2Smell_oof_pred_{seed}3407.csv"
    pd.DataFrame({
        "Dataset": all_df["Dataset"],
        "Mixture 1": all_df["Mixture 1"],
        "Mixture 2": all_df["Mixture 2"],
        "oof_pred": best_oof,
        "Experimental Values": all_df["Experimental Values"]
